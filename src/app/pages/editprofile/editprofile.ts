...
@Component({
  ...
  imports: [Header, MatFormFieldModule, MatIconModule, MatInputModule, MatDividerModule, MatButtonModule, NgIf, FormsModule, RouterLink],
  ...
  async loadUserProfile(): Promise<void> {
   this.isLoading = true;
    try {
      ...
      this.profileImage = profileData.profile_image  || 'assets/images/default-pfp.jpg'; 
